...
<div id="index">
        ...
        <table class="iconbox">
            <tbody>
                <tr>
                    ...
                    <td>
                        <img src="/imgs/index/icon2.png" alt="">
                        <h2>愿景</h2>
                        <p>打造中国一流、世界领先的<br>高端人才成长与创新教育服务的综合旗舰</p>
                    </td>
                    <td class="last">
                        <img src="/imgs/index/icon3.png" alt="">
                        <h2>价值观</h2>
                        <p>以人为本，创新引领，追求卓越</p>
                    </td>
                </tr>
    ...
    <div id="history">
        ...
        <div class="historyline">
            <img src="<?php echo $this->mimgUrl ?>history.png" class="responsive">
        </div>
    </div>
    ...
    <div id="map">
        ...
        <div class="imgbox">
            <div>
                <img src="<?php echo $this->mimgUrl ?>map1.jpg" alt="">
            </div>
            <div>
                <img src="<?php echo $this->mimgUrl ?>map2.jpg" alt="">
            </div>
        </div>
    </div>
